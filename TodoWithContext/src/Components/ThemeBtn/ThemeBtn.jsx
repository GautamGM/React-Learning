...
import son from "../../assets/image/sun.png"
import moon from "../../assets/image/moonlight.png"
export default function ThemeBtn() {
   const {themeMode,darkMode,lightMode}=useTod()
    ...
    return (
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        {themeMode==="dark"?<span><img src={moon} alt="moon" /></span>:<span> <img src={son} alt="son" /> </span>}
      </label>
    );
  }
